    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-1 bg-white p-8 rounded-lg shadow-md flex flex-col items-center">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4 flex flex-col justify-center">
                ...
                <p className="text-gray-600">support@cvbuilder.com</p>
              </div>
            </div>
          </div>
            ...
            {formStatus.isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition-colors disabled:opacity-70"
                >
