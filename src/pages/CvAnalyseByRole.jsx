      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
              ...
              <div className="text-center">
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="flex-1 bg-[#3498db] text-white py-2 px-4 rounded hover:bg-[#2980b9] transition"
                  >
                    Upgrade
                  </button>
                  <button
                    onClick={() => setShowSubscriptionModal(false)}
                    className="flex-1 border border-gray-300 text-gray-700 py-2 px-4 rounded hover:bg-gray-100 transition"
                  >
                    Cancel
                  </button>
                </div>
        ...
        {!analysisResults ? (
          <>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-[#2c3e50] mb-4">2. Choose Analysis Scope</h2>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                <div className="flex items-center mb-4">
                  <input
                    ...
                    className="h-4 w-4 text-[#3498db] focus:ring-[#3498db] border-gray-300"
                  />
                  <label htmlFor="generic-scope" className="ml-2 block text-base font-medium text-gray-700">
                    Generic Analysis (Recommended)
                  </label>
                </div>
                
                <div className="ml-6 mb-6 text-gray-600 text-sm">
                ...
                <div className="flex items-center mb-4">
                  <input
                    ...
                    className="h-4 w-4 text-[#3498db] focus:ring-[#3498db] border-gray-300"
                  />
                  <label htmlFor="role-specific" className="ml-2 block text-base font-medium text-gray-700">
                  ...
                  <div className="ml-6 space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        className="mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 rounded-md focus:outline-none focus:ring-[#3498db] focus:border-[#3498db]"
                      >
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="bg-[#3498db] text-white py-2 px-6 rounded-md hover:bg-[#2980b9] transition"
              >
                Analyse Another CV
              </button>
            </div>
