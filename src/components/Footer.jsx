        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-6 text-sm md:text-base">
              ...
              <a href="https://www.linkedin.com/company/cv-builder-pro" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white" aria-label="LinkedIn">
