    ...
    <section className="py-20 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4">
          ...
          {templates.map((template) => (
            <div key={template.id} className="group">
              <div className="relative aspect-[3/4] mb-4 rounded-lg overflow-hidden shadow-lg group-hover:shadow-xl transition-all duration-300">
                <div className={`w-full h-full ${template.color} ${template.darkColor} bg-opacity-20 flex items-center justify-center`}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <Link
                      ...
                      className="w-full inline-flex items-center justify-center px-6 py-3 text-[#2c3e50] dark:text-gray-800 bg-white dark:bg-gray-200 rounded-full font-semibold hover:bg-[#FFCFB3] dark:hover:bg-[#FFCFB3] transition-all duration-200"
                    >
                      Use This Template
                    </Link>
                  </div>
              ...
              <h3 className="text-lg font-semibold text-[#2c3e50] dark:text-white mb-1">{template.name}</h3>
        ...
        <div className="mt-16 text-center">
          <Link
            to="/templates"
            className="inline-flex items-center justify-center px-8 py-3 text-lg font-semibold text-white bg-[#E78F81] dark:bg-[#d36e62] rounded-full hover:bg-[#d36e62] dark:hover:bg-[#c65c50] transition-all duration-200 shadow-md hover:shadow-lg"
          >
