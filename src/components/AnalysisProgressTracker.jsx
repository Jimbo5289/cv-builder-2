            ...
            <div className="flex flex-col items-center relative group">
              <div 
                className={`w-8 h-8 flex items-center justify-center rounded-full border-2 transition-all duration-200 
                  ...
                  ${step.id === 2 && isAnalyzing ? 'animate-pulse border-blue-500 bg-blue-100' : ''}
                `}
              >
              ...
              {/* Tooltip */}
              <div className="hidden group-hover:block absolute -bottom-12 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded px-2 py-1 whitespace-nowrap">
                {step.description}
              </div>
            </div>
